...
path = r'\Users\lakeland\Desktop\Data_Extraction\*.csv' #the directory path
...
frame.to_excel (r'\Users\lakeland\Desktop\Data_Extraction\main.xlsx', "a", index = None, header=False)

#to launch the excel file
os.system('start "excel" "\\Users\\lakeland\\Desktop\\Data_Extraction\\main.xlsx"')